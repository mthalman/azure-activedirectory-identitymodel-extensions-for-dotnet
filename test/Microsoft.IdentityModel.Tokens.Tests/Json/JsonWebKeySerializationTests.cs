...
namespace Microsoft.IdentityModel.Tokens.Json.Tests
{
    public class JsonWebKeySerializationTests
    {
        ...
        public void DeserializeCheckingExceptions(JsonSerializerTheoryData theoryData)
        {
            ...
            JsonWebKeyNet8 jsonWebKeyDeserialize = null;
            JsonWebKeyNet8 jsonWebKeyRead = null;

            try
            {
                jsonWebKeyDeserialize = System.Text.Json.JsonSerializer.Deserialize<JsonWebKeyNet8>(theoryData.Json);
        ...
        public void Deserialize(JsonWebKeyTheoryData theoryData)
        {
            ...
            JsonWebKeyNet8 jsonWebKeySerialize = null;
            JsonWebKeyNet8 jsonWebKeyReader = null;
            JsonWebKey jsonWebKey = null;

            try
            {
                jsonWebKeySerialize = System.Text.Json.JsonSerializer.Deserialize<JsonWebKeyNet8>(theoryData.Json);
                theoryData.JsonSerializerExpectedException.ProcessNoException(context);
            }
            catch (Exception ex)
            {
            ...
            try
            {
                jsonWebKeyReader = new JsonWebKeyNet8(theoryData.Json);
                theoryData.JsonReaderExpectedException.ProcessNoException(context);
            }
            catch (Exception ex)
            {
            ...
            // when comparing JsonWebKey (Newtonsoft.Json) and JsonWebKeyNet8 (System.Text.Json) we ignore the AdditionalData property.
            // because JsonWebKey (Newtonsoft.Json) sets a object and JsonWebKeyNet8 (System.Text.Json) sets a JsonElement.
            CompareContext localContext = new CompareContext(theoryData);
            localContext.PropertiesToIgnoreWhenComparing.Add(typeof(JsonWebKeyNet8), new List<string> { "AdditionalData" });
        ...
        public void Serialize(JsonWebKeyTheoryData theoryData)
        {
            ...
            try
            {
                string jsonWebKeyString = JsonConvert.SerializeObject(theoryData.JsonWebKey);
                string jsonWebKeySerialize = System.Text.Json.JsonSerializer.Serialize<JsonWebKeyNet8>(theoryData.JsonWebKeyNet8);
                string jsonWebKeyWrite = JsonWebKeySerializer.Write(theoryData.JsonWebKeyNet8);

                JsonWebKey jsonWebKey = JsonConvert.DeserializeObject<JsonWebKey>(jsonWebKeyWrite);
                JsonWebKeyNet8 jsonWebKeyDeserialize = System.Text.Json.JsonSerializer.Deserialize<JsonWebKeyNet8>(jsonWebKeyString);
                JsonWebKeyNet8 jsonWebKeyRead = new JsonWebKeyNet8(jsonWebKeyString);
                if (!IdentityComparer.AreEqual(jsonWebKeyDeserialize, jsonWebKeyRead, context))
                    context.Diffs.Add("JsonWebKeyNet8.Deserialize != JsonWebKeyNet8.Read");

                IdentityComparer.AreEqual(jsonWebKeyDeserialize, jsonWebKey, context);
                IdentityComparer.AreEqual(jsonWebKeyRead, jsonWebKey, context);
            }
            catch (Exception ex)
            {
                theoryData.ExpectedException.ProcessException(ex, context);
        ...
        public static TheoryData<JsonWebKeyTheoryData> SerializeDataSet
        {
            get
            {
                ...
                theoryData.Add(new JsonWebKeyTheoryData("AllPropertiesSet")
                {
                    ...
                    JsonWebKeyNet8 = FullyPopulatedNet8()
                });
        ...
        private static JsonWebKeyNet8 FullyPopulatedNet8()
        {
            JsonWebKeyNet8 jsonWebKey = new JsonWebKeyNet8
            {
