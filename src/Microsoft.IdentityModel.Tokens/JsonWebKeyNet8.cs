...
namespace Microsoft.IdentityModel.Tokens
{
    ...
    /// </summary>
    internal class JsonWebKeyNet8 : SecurityKey
    {
        internal const string _className = "Microsoft.IdentityModel.Tokens.JsonWebKeyNet8";
        private IList<string> _keyOps = new List<string>();
        private string _kid;

        /// <summary>
        /// Initializes an new instance of <see cref="JsonWebKeyNet8"/>.
        /// </summary>
        public JsonWebKeyNet8()
        {
        }

        /// <summary>
        /// Returns a new instance of <see cref="JsonWebKeyNet8"/>.
        /// </summary>
        /// <param name="json">A string that contains JSON Web Key parameters in JSON format.</param>
        /// <returns><see cref="JsonWebKeyNet8"/></returns>
        ...
        public static JsonWebKeyNet8 Create(string json)
        {
            if (string.IsNullOrEmpty(json))
                throw LogHelper.LogArgumentNullException(nameof(json));

            return new JsonWebKeyNet8(json);
        }

        /// <summary>
        /// Initializes an new instance of <see cref="JsonWebKeyNet8"/> from a json string.
        /// </summary>
        /// <param name="json">A string that contains JSON Web Key parameters in JSON format.</param>
        /// <exception cref="ArgumentNullException">If 'json' is null or empty.</exception>
        /// <exception cref="ArgumentException">If 'json' fails to deserialize.</exception>
        public JsonWebKeyNet8(string json)
        {
            if (string.IsNullOrEmpty(json))
                throw LogHelper.LogArgumentNullException(nameof(json));
        ...
        /// <summary>
        /// Gets the key id of this <see cref="JsonWebKeyNet8"/>.
        /// </summary>
        [JsonIgnore]
        ...
        public IList<string> KeyOps
        {
            ...
            set
            {
                _keyOps = value ?? throw LogHelper.LogArgumentNullException(nameof(value));
            }
        }
        ...
        internal string RepresentAsAsymmetricPublicJwk()
        {
            if (string.Equals(Kty, JsonWebAlgorithmsKeyTypes.EllipticCurve))
            {
                return $@"{{""{JsonWebKeyParameterNames.Kid}"":""{Kid}""}}" +
            ...
            throw LogHelper.LogExceptionMessage(new ArgumentException(
                LogHelper.FormatInvariant(
                    LogMessages.IDX10707,
                    LogHelper.MarkAsNonPII(nameof(Kty)),
                    LogHelper.MarkAsNonPII(string.Join(", ", JsonWebAlgorithmsKeyTypes.EllipticCurve, JsonWebAlgorithmsKeyTypes.RSA)),
                    LogHelper.MarkAsNonPII(nameof(Kty)))));
        }
