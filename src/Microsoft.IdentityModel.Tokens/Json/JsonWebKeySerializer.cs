...
namespace Microsoft.IdentityModel.Tokens.Json
{
    internal static class JsonWebKeySerializer
    {
        ...
        #region Read
        public static JsonWebKeyNet8 Read(string json)
        {
        ...
        /// <returns>A <see cref="JsonWebKeyNet8"/>.</returns>
        public static void Read(string json, JsonWebKeyNet8 jsonWebKey)
        {
            ReadOnlySpan<byte> bytes = Encoding.UTF8.GetBytes(json).AsSpan();
            Utf8JsonReader reader = new Utf8JsonReader(bytes);
            Read(ref reader, jsonWebKey);
        ...
        /// <param name="jsonWebKey"></param>
        /// <returns>A <see cref="JsonWebKeyNet8"/>.</returns>
        public static void Read(ref Utf8JsonReader reader, JsonWebKeyNet8 jsonWebKey)
        {
            ...
            do
            {
                ...
                {
                    string propertyName = JsonSerializerPrimitives.GetPropertyName(ref reader, JsonWebKeyNet8._className, true);
                    switch (propertyName)
                    {
                        // optional
                        ...
                        case JsonWebKeyParameterNames.KeyOps:
                            ...
                            if (JsonSerializerPrimitives.ReadStrings(ref reader, jsonWebKey.KeyOps, JsonWebKeyParameterNames.KeyOps, _className) == null)
                            {
                                throw LogHelper.LogExceptionMessage(
                        ...
                        case JsonWebKeyParameterNames.Oth:
                            JsonSerializerPrimitives.ReadStrings(ref reader, jsonWebKey.Oth, JsonWebKeyParameterNames.Oth, _className);
                            break;
                        ...
                        case JsonWebKeyParameterNames.X5c:
                            JsonSerializerPrimitives.ReadStrings(ref reader, jsonWebKey.X5c, JsonWebKeyParameterNames.X5c, _className);
                            break;
                        // optional
        ...
        #region Write
        public static string Write(JsonWebKeyNet8 jsonWebKey)
        {
        ...
        public static void Write(Utf8JsonWriter writer, JsonWebKeyNet8 jsonWebKey)
        {
